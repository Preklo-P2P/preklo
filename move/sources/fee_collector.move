module aptos_send::fee_collector {
    ...
    public entry fun collect_fee(
        ...
        assert!(exists<FeeCollector>(@aptos_send), error::not_found(E_FEE_COLLECTOR_NOT_INITIALIZED));
        ...
        if (currency_type == string::utf8(b"APT")) {
            ...
            coin::deposit(@aptos_send, fee_payment);
        };
    ...
    public fun is_initialized(): bool {
        exists<FeeCollector>(@aptos_send)
    }
